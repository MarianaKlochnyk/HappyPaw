...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/forgot-password-1/forgot-password-1.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/create-account-1/create-account-1.module').then(
        (m) => m.CreateAccount1PageModule
      ),
    data: { animation: 'none' },
  },
  {
    ...
    loadChildren: () =>
      import('./pages/forgot-password-2/forgot-password-2.module').then(
        (m) => m.ForgotPassword2PageModule
      ),
  },
  {
    path: 'forgot-password-3',
    loadChildren: () =>
      import('./pages/forgot-password-3/forgot-password-3.module').then(
        (m) => m.ForgotPassword3PageModule
      ),
  },
  {
    path: 'forgot-password-4',
    loadChildren: () =>
      import('./pages/forgot-password-4/forgot-password-4.module').then(
        (m) => m.ForgotPassword4PageModule
      ),
  },
  {
    path: 'confirm-1',
    loadChildren: () =>
      import('./pages/confirm-1/confirm-1.module').then(
        (m) => m.Confirm1PageModule
      ),
  },
  {
    path: 'confirm-2',
    loadChildren: () =>
      import('./pages/confirm-2/confirm-2.module').then(
        (m) => m.Confirm2PageModule
      ),
  },
  {
    path: 'sign-in-1',
    loadChildren: () =>
      import('./pages/sign-in-1/sign-in-1.module').then(
        (m) => m.SignIn1PageModule
      ),
  },
  {
    path: 'sign-in-2',
    loadChildren: () =>
      import('./pages/sign-in-2/sign-in-2.module').then(
        (m) => m.SignIn2PageModule
      ),
  },
  {
    path: 'create-account-2',
    loadChildren: () =>
      import('./pages/create-account-2/create-account-2.module').then(
        (m) => m.CreateAccount2PageModule
      ),
  },
  {
    path: 'create-account-3',
    loadChildren: () =>
      import('./pages/create-account-3/create-account-3.module').then(
        (m) => m.CreateAccount3PageModule
      ),
  },
  {
    path: 'homepage',
  ...
  },
  {
    path: 'confirm-3',
    loadChildren: () =>
      import('./pages/confirm-3/confirm-3.module').then(
        (m) => m.Confirm3PageModule
      ),
  },
  {
    path: 'history-of-donation',
    loadChildren: () =>
      import('./pages/history-of-donation/history-of-donation.module').then(
        (m) => m.HistoryOfDonationPageModule
      ),
  },
  {
    path: 'detailed-info',
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/usefull-information/usefull-information.module').then(
        (m) => m.UsefullInformationPageModule
      ),
  },
  {
    path: 'suportive-service',
    loadChildren: () =>
      import('./pages/suportive-service/suportive-service.module').then(
        (m) => m.SuportiveServicePageModule
      ),
  },
  {
    path: 'walking-pet',
    loadChildren: () =>
      import('./pages/walking-pet/walking-pet.module').then(
        (m) => m.WalkingPetPageModule
      ),
  },
  {
