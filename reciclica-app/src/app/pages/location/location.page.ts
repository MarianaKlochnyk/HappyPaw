    ...
    new google.maps.Marker({
      ...
      icon: {
        url: "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(`
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M22.3813 37.6459C31.5271 37.6459 3s8.9413 30.0395 38.9413 20.6567C38.9413 11.2738 31.5271 3.66748 22.3813 3.66748C13.2354 3.66748 5.82129 11.2738 5.82129 20.6567C5.82129 30.0395 13.2354 37.6459 22.3813 37.6459Z" fill="#A5E2DB" fill-opacity="0.3"/>
